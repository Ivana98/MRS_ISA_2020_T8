...
insert into clinical_center_admin (id, email, name, password, phone, surname, address_id, clinical_center_id) values (nextval('cust_seq_user'), 'clinic.center.admin@gmail', 'jovan', 'sifra1', '0614422', 'Plecas', 1, 1);
...
insert into clinical_mark (mark, clinic_id, patient_id) values (0.0, 1, 3);
...
insert into doctor (id, email, name, surname, phone, password, average_mark, specialisation, address_id, clinic_id) values (nextval('cust_seq_user'), 'doctor@gmail', 'Dragan', 'Karanovic', '+381619785', 'sifra111', 0, 0, 1, 1);
...
insert into examination (date, description, discount, was_on_examination, doctor_id, price_id, medical_room_id, patient_id) values ('2020-06-26 07:00', 'Obican rutinski pregled', 10.0, false, 5, 1, 2, null);
...
-- insert into prescription (description, expiration_date, quantity, validated, medication_id, nurse_id) values ('Opis recepta', '2020-08-26 23:59', 2, true, 1, 4);
