...
insert into clinic_admin (id, email, name, password, phone, surname, address_id, clinic_id, enabled, deleted) values (nextval('cust_seq_user'), 'clinic.admin@gmail.com', 'Nikola', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '0653355', 'Plecas', 1, 1, true, false);
...
insert into nurse (id, email, name, password, phone, surname, address_id, clinic_id, enabled, deleted) values (nextval('cust_seq_user'), 'nurse@gmail.com', 'Dusica', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', '064582', 'Vasic', 1, 1, true, false);
insert into absence (absence_type, start_date, end_date, user_id, deleted) values (1, '2020-04-15 10:00', '2020-04-24 10:00', 1, false);

insert into doctor (id, email, name, surname, phone, password, average_mark, specialisation, address_id, clinic_id, enabled, deleted) values (nextval('cust_seq_user'), 'doctor@gmail.com', 'Dragan', 'Karanovic', '0619785', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 0, 0, 1, 1, true, false);
...
insert into examination (date, description, discount, was_on_examination, doctor_id, price_id, medical_room_id, patient_id, deleted) values ('2020-04-26 07:00', 'Obican rutinski pregled', 10.0, true,  4, 1, 1, 2, false);
insert into examination (date, description, discount, was_on_examination, doctor_id, price_id, medical_room_id, patient_id, deleted) values ('2020-06-26 07:00', 'Obican rutinski pregled', 10.0, false, 4, 1, 2, null, false);
