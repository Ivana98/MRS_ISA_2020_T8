...
//	private double price;
	 ...
	 */
	public ExaminationTypeDTO(Long id, String duration, String interventionType, String specialisation) {
		super();
		this.id = id;
//		this.price = price;
...
//	}
	...
	public String toString() {
		return "ExaminationTypeDTO [id=" + id + ", duration=" + duration + ", interventionType="
